...
require_once 'Zend/Feed/Writer/Renderer/Entry/Rss91.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Feed_Writer_Renderer_Feed_Rss91
    ...
    implements Zend_Feed_Writer_Renderer_RendererInterface
{
    ...
    public function render()
    {
        ...
        foreach ($this->_container as $entry) {
            ...
            if ($entry instanceof Zend_Feed_Writer_Entry) {
                $renderer = new Zend_Feed_Writer_Renderer_Entry_Rss91($entry);
            } else {
                continue;
            }
    ...
    protected function _setTitle(DOMDocument $dom, DOMElement $root)
    {
        if(!$this->getDataContainer()->getTitle()) {
            ...
            $message = 'RSS 0.91 feed elements MUST contain exactly one'
    ...
    protected function _setImage(DOMDocument $dom, DOMElement $root)
    {
        ...
        || !is_string($image['title'])) {
            require_once 'Zend/Feed/Exception.php';
            $message = 'RSS 0.91 feed images must include a title';
            $exception = new Zend_Feed_Exception($message);
            if (!$this->_ignoreExceptions) {
                throw $exception;
            } else {
